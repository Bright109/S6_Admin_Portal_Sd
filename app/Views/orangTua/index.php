...
<div class="container p-4">
  <div class="p-4">
    <a href="/orang_tua/tambah" class="btn btn-primary">Tambah Data</a>
  </div>
  <table class=" table table-bordered">
    <thead>
      <tr>
        ...
        <th scope="col">Hubungan Dengan Siswa</th>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?= $result['alamat']; ?></td>
        <td><?= $result['email']; ?></td>
        <td><?= $result['hubungan_dengan_siswa'];?></td>
        <td>
          <ul>
        ...
        <td>
          <div class="d-flex">
            <a href="/orang_tua/<?= $result['id']; ?>" class="text-primary me-1" title="Detail" style="text-decoration : none">
              <i class="mdi mdi-magnify"></i>
            </a>
            <a href="/orang_tua/edit/<?= $result['id']; ?>" class="text-success me-1" title="Edit"
