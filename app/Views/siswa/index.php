  ...
  <table class=" table table-bordered">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?= $result['orang_tua']; ?></td>
        <td><?= $result['kelas'];?></td>
        <td>
          <div class="d-flex">
            <a href="/siswa/<?= $result['id']; ?>" class="text-primary" title="Detail" style="text-decoration : none">
              <i class="mdi mdi-magnify me-1"></i>
            </a>
            <a href="/siswa/edit/<?= $result['id']; ?>" class="text-success me-1" title="Edit"
